	...
	<div class="b-wrap">
		...
		<div class="b-content">
			...
			<div class = "b-content-main">
                ...
                <form id="reportQuality_form" action = "reportQualityList" method = "post" >
               	...
               	<table lay-filter="parse-table-demo">
                    ...
                    <c:forEach items="${page.result }" var="item">
                    	<tr>
                    		...
                    		<td>
                    			<fmt:formatNumber type="number" value="${item.totalusermoscount }" maxFractionDigits="5"/>
                    		</td>
                    		<td>
                    			<fmt:formatNumber type="number" value="${item.vodusermoscount }" maxFractionDigits="5"/>
                    		</td>
                    		<td>
                    			<fmt:formatNumber type="number" value="${item.backusermoscount }" maxFractionDigits="5"/>
                    		</td>
                    		<td>
                    			<fmt:formatNumber type="number" value="${item.liveusermoscount }" maxFractionDigits="5"/>
                    		</td>
                    </c:forEach>
                    </tbody>
               	</table>
