	...
	<div class="b-wrap">
		...
		<div class="b-content">
			...
			<div class = "b-content-main">
                ...
                <form id="addWarnGroup_form" action ="addWarnGroup" method = "post" onsubmit="return check()">
                	<div class="b-form">
                		<div class="head">
                			<div class="l bj-12">
                				<p>新增</p>
                		...
                		<table class="tableSt2 main" >
                			<tr>
	                			...
	                			<td>
	               					<input type="text" style="width:200px"  class="form-input" name="groupName" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	                				<input type="text" style="width:200px"  class="form-input" name="groupDesc" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	                				<input type="text" style="width:200px"  class="form-input" name="orderBy" value="0"/>
	                			</td>
                			</tr>
                		</table>
                	</div>
