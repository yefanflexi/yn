	...
	<div class="b-wrap">
		...
		<div class="b-content">
			...
			<div class = "b-content-main">
                ...
                <form id="reportExpert_form" action = "reportExpertList" method = "post" >
...
$("#sel_platform").val('${expert.platform}');
$("#sel_location").val('${expert.location}');
$("#sel_provider").val('${expert.provider}');
$.pageLwFn("fun",'${page.pageNo}','${page.totalPages}','${page.pageSize}','${page.totalCount}');
	function fun(num){
		$("#xmgl_pageNo").val(num);
		$('#reportExpert_form').submit();
	}
...
// 	            + seperator2 + date.getSeconds(); 
	...
	function _export(){
		window.location.href='<%=path%>/rest/reportExpert/reportExpertList?export=true'
			+"&"+$("#reportExpert_form").serialize();
	}
