	...
	<div class="b-wrap">
		...
		<div class="b-content">
			...
			<div class = "b-content-main">
                ...
                <input type="hidden" id="navVal2" value="30010_106"/>
                <form id="reportUserbehaviorSummary_form" action = "reportUserbehaviorSummaryList" method = "post" >
	                ...
	                <table lay-filter="parse-table-demo">
	                	<thead>
	               		...
	               		<tbody>
	                    <c:forEach items="${userbehaviorSum }" var="item">
	                    	<tr>
	                    		<td>
	                    		...
	                    		<td>
	                    			<fmt:formatNumber type="number" value="${item.liveviewsec}" maxFractionDigits="5"/>
	                    		</td>
	                    		<td>
	                    			<fmt:formatNumber type="number" value="${item.vodviewsec}" maxFractionDigits="5"/>
	                    		</td>
	                    		<td>
	                    			<fmt:formatNumber type="number" value="${item.totalviewsec}" maxFractionDigits="5"/>
	                    		</td>
	                    		<td>
	                    			<fmt:formatNumber type="number" value="${item.avgviewsec}" maxFractionDigits="5"/>
	                    		</td>
	                    		<td>
	                    			<fmt:formatNumber type="number" value="${item.useronlinesec}" maxFractionDigits="5"/>
	                    		</td>
	                    	</tr>
	                    </c:forEach>
	                    </tbody>
...
// 	            + seperator2 + date.getSeconds(); 
	...
	function _export(){
		window.location.href='<%=path%>/rest/reportUserbehavior/reportUserbehaviorSummaryList?export=true'
			+"&"+$("#reportUserbehaviorSummary_form").serialize();
	}
