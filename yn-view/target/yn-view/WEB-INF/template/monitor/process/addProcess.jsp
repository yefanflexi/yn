	...
	<div class="b-wrap">
		...
		<div class="b-content">
			...
			<div class = "b-content-main">
                ...
                <form id="addProcess_form" action ="addProcess" method = "post" onsubmit="return check()">
                	<div class="b-form">
                		<div class="head">
                			<div class="l bj-12">
                				<p>新增</p>
                		...
                		<table class="tableSt2 main" >
							<tr>
	                			...
	                			<td>
	               					<input type="text" style="width:200px"  class="form-input" name="procName" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	               					<input type="text" style="width:200px"  class="form-input" name="procCode" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	                				<input type="text" style="width:200px"  class="form-input" name="procDesc" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	                				<select name="monitorTag" class="form-input" style="width: 200px">
                			...
                			<tr>
	                			...
	                			<td>
	                				<select name="customTag" class="form-input" style="width: 200px">
                			...
                			<tr>
	                			...
	                			<td>
	                				<select name="procType" class="form-input" style="width: 200px">
