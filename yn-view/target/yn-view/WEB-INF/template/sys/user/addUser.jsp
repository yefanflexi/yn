	...
	<div class="b-wrap">
		...
		<div class="b-content">
			...
			<div class = "b-content-main">
                ...
                <form id="addUser_form" action ="addUser" method = "post" onsubmit="return check()">
                	<div class="b-form">
                		<div class="head">
                			<div class="l bj-12">
                				<p>新增</p>
                		...
                		<table class="tableSt2 main" >
                			<tr>
	                			...
	                			<td>
	               					<input type="text" style="width:200px"  class="form-input" name="userId" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	               					<input type="password" style="width:200px"  class="form-input" name="password" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	                				<input type="text" style="width:200px"  class="form-input" name="realName" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
	                			...
	                			<td>
	                				<input type="text" style="width:200px"  class="form-input" name="phone" />
	                			</td>
                			</tr>
                			<tr>
                				<td width="200px" align="center">
