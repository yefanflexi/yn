	...
	<div class="b-wrap">
		...
		<div class="b-content">
			<div class="b-content-head">
				<div class="l">
					<span class="s1">终端机顶盒性能汇总报表</span>
				</div>
				<div class="r">
				</div>
			...
			<div class = "b-content-main">
                ...
                <input type="hidden" id="navVal2" value="30010_108"/>
                <form id="reportProbeperSummary_form" action = "reportProbeperSummaryList" method = "post" >
                	...
                	<table class="layui-table" lay-filter="parse-table-demo">
	                    ...
	                    <tbody>
	                    	<c:forEach items="${reportProbeperSum }" var="item">
		                    	<tr>
		                    		...
		                    		<td>
		                    			<fmt:formatNumber type="number" value="${item.bootupsec }" maxFractionDigits="2"/>
		                    		</td>
		                    		<td>
		                    			<fmt:formatNumber type="number" value="${item.vodlatencsec }" maxFractionDigits="2"/>
		                    		</td>
		                    		<td>
		                    			<fmt:formatNumber type="number" value="${item.egprspsec }" maxFractionDigits="2"/>
		                    		</td>
		                    	</tr>
		                    </c:forEach>
	                    </tbody>
...
$("#sel_platform").val('${reportProbeper.platform}');
$("#sel_location").val('${reportProbeper.location}');
$("#sel_provider").val('${reportProbeper.provider}');
...
// 	            + seperator2 + date.getSeconds(); 
	...
	function _export(){
		window.location.href='<%=path%>/rest/reportProbeper/reportProbeperSummaryList?export=true'
			+"&"+$("#reportProbeperSummary_form").serialize();
	}
