	...
	<div class="b-wrap">
		...
		<div class="b-content">
			<div class="b-content-head">
				<div class="l">
					<span class="s1">直播频道访问TOP10报表</span>
				</div>
				<div class="r">
				</div>
			...
			<div class = "b-content-main">
                ...
                <form id="reportTopLiveChannel_form" action = "reportTopLiveChannelList" method = "post" >
                ...
                <table lay-filter="parse-table-demo" >
               		<thead>
               		<tr>
               			<th lay-data="{field:'timestamp', width:210}">日期</th>
               			<th lay-data="{field:'channelname', width:610}">频道名</th>
               			<th lay-data="{field:'playtime', width:210}">访问时长(ms)</th>
                    </tr>
                    </thead>
               		<tbody>
...
$.pageLwFn("fun",'${page.pageNo}','${page.totalPages}','${page.pageSize}','${page.totalCount}');
	function fun(num){
		$("#xmgl_pageNo").val(num);
		$('#reportTopLiveChannel_form').submit();
	}
...
// 	            + seperator2 + date.getSeconds(); 
	...
	function _export(){
		window.location.href='<%=path%>/rest/reportTopLiveChannel/reportTopLiveChannelList?export=true'
			+"&"+$("#reportTopLiveChannel_form").serialize();
	}
