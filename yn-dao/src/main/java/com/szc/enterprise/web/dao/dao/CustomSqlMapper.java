...
public interface CustomSqlMapper{
	...
	List<ReportQuality> selectByExampleDay_rQuality_Group(ReportQualityExample example, Page<ReportQuality> page);
	
	List<ReportQualityNew> selectByExampleDay_rQuality_Group_new(ReportQualityNewExample example);
	
	List<ReportQualityNew> selectByExampleDay_rQuality_Group_new(ReportQualityNewExample example, Page<ReportQualityNew> page);
	...
	List<ReportUserbehavior> selectByExampleDay_rUserbehavior_Group(ReportUserbehaviorExample example, Page<ReportUserbehavior> page);
	...
	List<ReportExpert> selectByExampleDay_rExpert_Group(ReportExpertExample example, Page<ReportExpert> page);
	...
	List<ReportProbeper> selectByExampleDay_rProbeper_Group(ReportProbeperExample example, Page<ReportProbeper> page);
